...
const PostsFilter = ({ expandedAccordion, handleChangeAccordions }) => {
  const classes = useStyles();

  function handleChangeAccordion(event, isExpandedFilter) {
    handleChangeAccordions("panelPosts")(event, isExpandedFilter);
  }

  return (
    <Accordion
      expanded={expandedAccordion === "panelPosts"}
